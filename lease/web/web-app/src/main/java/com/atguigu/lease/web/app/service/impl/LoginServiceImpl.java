...
public class LoginServiceImpl implements LoginService {
    ...
    public void getCode(String phone) {
        String randomString = CodeUtil.getRandomString(6);
        ...
        smsService.sendSms(phone, randomString);
        stringRedisTemplate.opsForValue().set(Key, randomString,RedisConstant.APP_LOGIN_CODE_TTL_SEC, TimeUnit.SECONDS);
    }
